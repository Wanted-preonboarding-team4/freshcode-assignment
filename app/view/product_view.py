...
@router.patch("/{menu_id}", dependencies=[Depends(JWTBearerForAdminOnly())])
...
@router.get("/menu_list", dependencies=[Depends(JWTBearer())])
...
@router.get("/menu/{menu_id}", dependencies=[Depends(JWTBearer())])
